    ...
    <div className="app-shell">
      <aside className={`sidebar ${sidebarOpen ? "sidebar-open" : ""}`}>
        <div className="brand">
          ...
          <div>
            <div className="brand-name">Fund Advisor</div>
            <div className="brand-caption">可信投研助手</div>
          </div>
        </div>
        ...
        <div className="conversation-label">临时对话</div>
        <nav className="conversation-list" aria-label="临时对话">
          {conversations.map((conversation) => (
            <button
              className={`conversation-item ${conversation.key === activeKey ? "active" : ""
                }`}
              type="button"
        ...
        <div className="sidebar-note">
          <ShieldIcon />
          <div>
            <strong>会话不会持久化</strong>
            <span>刷新页面或服务重启后清空</span>
          </div>
        </div>
      </aside>
      ...
      <main className="main-panel">
        <header className="topbar">
          ...
          <div className="mode-badge">审计数据模式</div>
        </header>
        ...
        <section className="chat-stage">
          ...
          <div className="composer-wrap">
            ...
            <p className="disclaimer">
              内容仅供个人研究参考，不构成投资建议。市场数值仅来自已审计工具。
            </p>
          </div>
        </section>
      </main>
...
function ShieldIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 3 5.5 5.8v5.8c0 4.2 2.8 7.8 6.5 9.4 3.7-1.6 6.5-5.2 6.5-9.4V5.8L12 3Z" />
